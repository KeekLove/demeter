 ...
 */
public class MybatisRestaurant {
    /**
    ...
    public SqlSessionFactoryBean getSqlSessionFactoryBean() throws IOException {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com/demeter/common/pojo,com/demeter/restaurant/pojo");
    ...
    public MapperScannerConfigurer getMapperScannerConfigurer(){
        ...
        mapperScannerConfigurer.setBasePackage("com/demeter/restaurant/dao");
